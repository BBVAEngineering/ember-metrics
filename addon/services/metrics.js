...
export default Service.extend({
   ...
   */
	init() {
		const adapters = this.options.metricsAdapters === undefined ? emberArray() : this.options.metricsAdapters;
		...
		set(this, 'appEnvironment', this.options.environment === undefined ? 'development' : this.options.environment);
		set(this, '_adapters', {});
		set(this, 'context', {});
   ...
   */
	willDestroy() {
		...
		for (const adapterName in cachedAdapters) {
   ...
   * current application environment. De	ults to all environments if the option
   * is `all` or undefined.
   *
