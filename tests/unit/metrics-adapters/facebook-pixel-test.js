...
module('facebook-pixel adapter', (hooks) => {
	setupTest(hooks);
	...
	test('#trackEvent calls `fbq.track` with the right arguments', (assert) => {
	...
	test('#trackPage calls `fbq.track` with the right arguments', (assert) => {
